...
class World {
  ...
  createTree(x, z) {
    ...
    const foliageMat =
      Math.random() > 0.5 ? this.materials.foliage : this.materials.foliageDark;
  ...
  createGrassTufts() {
    ...
    const instancedTufts = new THREE.InstancedMesh(
      tuftGeom,
      tuftMat,
      instanceCount
    );
