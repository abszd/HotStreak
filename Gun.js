...
class Gun {
    ...
    create() {
        const metalDark = new THREE.MeshStandardMaterial({ color: 0x2a2a2a, metalness: 0.8, roughness: 0.3 });
        const metalLight = new THREE.MeshStandardMaterial({ color: 0x4a4a4a, metalness: 0.7, roughness: 0.4 });
        const wood = new THREE.MeshStandardMaterial({ color: 0x5c3a21, roughness: 0.8 });
        const accent = new THREE.MeshStandardMaterial({ color: 0x1a1a1a, metalness: 0.9, roughness: 0.2 });
