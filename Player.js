...
class Player {
    ...
    swayCamera(delta) {
        ...
        const pitchDif = (-frontback * maxTilt * 0.8 - this.curPitch) * delta * 8;
        ...
        this.camera.quaternion.multiply(rollQuat).multiply(pitchQuat);
    ...
    update(delta) {
        ...
        if (this.isGrounded()) {
            this.jet.tank += this.jet.tank < this.jet.fuel ? delta : this.jet.fuel - this.jet.tank;
        }
